      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
            Discover how we've helped businesses across Pakistan transform their operations, increase efficiency, and achieve remarkable growth through innovative technology solutions.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-white mb-2">50+ Case Studies</h3>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-white mb-2">300% ROI Average</h3>
              <p className="text-gray-300 text-sm text-center">
