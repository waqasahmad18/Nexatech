      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
            Behind every great project is a great team. Meet the passionate individuals who bring innovation, expertise, and creativity to every solution we build.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-white mb-2">25+ Experts</h3>
              <p className="text-gray-300 text-sm text-center">
                Skilled professionals across development, design, and management
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-white mb-2">8+ Years Experience</h3>
              <p className="text-gray-300 text-sm text-center">
                Average experience in cutting-edge technologies
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Award Winners</h3>
              <p className="text-gray-300 text-sm text-center">
                Recognized for excellence and innovation in the industry
              </p>
            </motion.div>
          </div>
        </motion.div>
