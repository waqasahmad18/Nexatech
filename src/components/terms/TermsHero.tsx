...
export default function TermsHero() {
  return (
    <section className="relative pt-24 pb-16 flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white via-gray-200 to-slate-300 bg-clip-text text-transparent mb-6">
            Terms of Service
          </h1>
          
          <p className="text-lg md:text-xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
            Please read these terms carefully before using NexaTech services. These terms govern your use of our software solutions and services.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-300 text-sm text-center">
                Binding terms for using our services
              </p>
            </motion.div>
